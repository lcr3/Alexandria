...
internal enum L10n {
  ...
  /// 登録図書館をリセットする
  internal static let locationDeleteButtonTitle = L10n.tr("Localizable", "locationDeleteButtonTitle")
  /// 位置情報が設定されていません
  ...
  /// 該当なし
  internal static let searchBookSectionNotFoundTitle = L10n.tr("Localizable", "searchBookSectionNotFoundTitle")
  /// 検索
