...
protocol SearchBookResultWireFrameProtocol {
    static func makeSearchBookResultView(title: String, isbn: String, libraries: [Library], calilClient: CalilClientProtocol, storageClient: StorageClientProtocol) -> AnyView
}
...
struct SearchBookResultWireFrame: SearchBookResultWireFrameProtocol {
    static func makeSearchBookResultView(
        ...
        let presenter = SearchBookResultPresenter(
